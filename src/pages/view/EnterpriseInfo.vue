    ...
    <div class="content">
      ...
      <div class="copy-box">
        <div class="name-and-pass">
          ...
          <p>密码：<span>0#NxLRFT9E</span></p>
        </div>
        <button class="copy" @click="toCopy">复制</button>
      </div>
      <a-button type="primary" class="bind">确定并绑定</a-button>
      <p class="tips light-tip">账号密码已发送到联系人手机中</p>
      <p class="tips light-tip">您可以在个人中心修改密码 <a href="">登录</a> 并 <a href="">修改密码</a></p>
    </div>
  </div>
</template>
